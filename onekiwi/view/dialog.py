...
class ClassPanel ( wx.Panel ):
	...
	def __init__( self, parent, id = wx.ID_ANY, pos = wx.DefaultPosition, size = wx.Size( -1,-1 ), style = wx.TAB_TRAVERSAL, name = wx.EmptyString ):
		...
		sbSizer1 = wx.StaticBoxSizer( wx.StaticBox( self.m_scrolledWindow2, wx.ID_ANY, u"Create Class:" ), wx.HORIZONTAL )
		...
		bSizer18.Add( sbSizer1, 0, wx.ALL|wx.EXPAND, 5 )

		sbSizer2 = wx.StaticBoxSizer( wx.StaticBox( self.m_scrolledWindow2, wx.ID_ANY, u"Edit Class:" ), wx.VERTICAL )
		...
		bSizer18.Add( sbSizer2, 1, wx.ALL|wx.EXPAND, 5 )


		self.m_scrolledWindow2.SetSizer( bSizer18 )
		self.m_scrolledWindow2.Layout()
		bSizer18.Fit( self.m_scrolledWindow2 )
